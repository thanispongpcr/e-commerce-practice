...
<template>
    <div>
        <div class="navbar bg-base-100">
            <div class="flex-1">
                <RouterLink :to="{ name: 'home' }" class="btn btn-ghost text-2xl">Thanis Shop</RouterLink>
            </div>
                ...
                <div class="dropdown dropdown-end">
                    ...
                    <div tabindex="0" class="mt-3 z-[1] card card-compact dropdown-content w-52 bg-base-100 shadow">
                        <div class="card-body">
                            ...
                            <span class="text-info">{{ cartStore.summaryPrice }} ฿</span>
        ...
        <footer class="footer footer-center p-44 bg-neutral text-neutral-content">
            <aside>
